...
```javascript
const makeWASocket = require("@zeetasiv1/baileys").default;
const { useMultiFileAuthState } = require("@zeetasiv1/baileys");
...
```javascript
const makeWASocket = require("@zeetasiv1/baileys").default;
const { DisconnectReason, useMultiFileAuthState } = require("@zeetasiv1/baileys");
...
```javascript
const makeWASocket = require("@zeetasiv1/baileys").default;
const { makeInMemoryStore } = require("@zeetasiv1/baileys");
...
const { downloadMediaMessage, getContentType } = require("@zeetasiv1/baileys");
